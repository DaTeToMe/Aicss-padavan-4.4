...
add_rules()
{
	...
	touch /tmp/lazy.txt && curl -k -s -o /tmp/lazy.txt --connect-timeout 5 --retry 3 https://raw.githubusercontent.com/HDYOU/router-adbyby-AdRules/main/anti-ad-easylist-adbyby.txt
